...
import com.example.nearbyplaces.Map.GetNerbyPlace;
...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    TextView live_location, weather;
    ...
    public void onLocationChanged(Location location) {
        ...
        try {
            ...
            live_location.setText(fullAddress);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void onClick(View v)
    {
        ...
        GetNerbyPlace getNearbyPlacesData = new GetNerbyPlace();
...
//                break;
            ...
            case R.id.store :
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MainActivity.this, "Showing Nearby Store", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.library :
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MainActivity.this, "Showing Nearby Library", Toast.LENGTH_SHORT).show();
                break;
